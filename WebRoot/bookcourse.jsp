...
<head>
    ...
    <script type="application/javascript">
        ...
        function body_load() {
            ...
            $.post("/classCheck/getalldepjson", function (msg) {
...
//            }
            ...
            $.post("/classCheck/getempbydepid", {depid: departmentid}, function (msg) {
                for (var i = 0; i < msg.length; i++) {
                    var item = msg[i];
...
<div class="page-body">
    ...
    <div class="page-content">
        ...
        <form action="/classCheck/dobookmeeting" method="post">
            <fieldset>
                <legend>课程信息</legend>
                <table class="formtable">
                    ...
                    <tr>
                        <td class="command" colspan="2">
                            <input type="submit" class="clickbutton" value="预定课程"/>
